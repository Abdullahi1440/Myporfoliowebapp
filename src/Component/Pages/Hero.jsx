...
const Header = () => {
  ...
  return (
    <div className='block bg-purple-900  dark:bg-gray-900 flex-wrap  shadow py-10 px-5 mx-auto my-5 w-[90%]  rounded-2xl   '>
...
If you need a reliable developer to bring your project to life, I'm here to help you.</span>
      <span className=' block text-3xl flex-wrap text-yellow-600  font-light  capitalize text-center items-center  justify-center mt-3  py-3  '>
          {
            typeEffect
          }
        </span>
